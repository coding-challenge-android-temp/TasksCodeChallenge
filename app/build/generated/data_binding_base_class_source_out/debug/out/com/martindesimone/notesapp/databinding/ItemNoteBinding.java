...
public abstract class ItemNoteBinding extends ViewDataBinding {
  @NonNull
  public final MaterialCardView itemNoteCardView;
  ...
  @Bindable
  protected AllTasksQuery.AllTask mTask;

  protected ItemNoteBinding(Object _bindingComponent, View _root, int _localFieldCount,
      MaterialCardView itemNoteCardView, TextView noteContentText, TextView noteTitleText) {
    super(_bindingComponent, _root, _localFieldCount);
    this.itemNoteCardView = itemNoteCardView;
    this.noteContentText = noteContentText;
    this.noteTitleText = noteTitleText;
  }

  public abstract void setTask(@Nullable AllTasksQuery.AllTask task);

  @Nullable
  public AllTasksQuery.AllTask getTask() {
    return mTask;
  }
